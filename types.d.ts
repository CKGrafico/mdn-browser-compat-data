 ...
 */
export interface Browsers extends Record<BrowserNames, BrowserStatement> {
}
...
export interface Identifier extends Partial<Record<Exclude<string, '__compat'>, Identifier>> {
  /**
